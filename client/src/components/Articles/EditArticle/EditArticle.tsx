...
export default function EditArticle() {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            ...
            await articleService.edit(slug, {
                title: form.title,
    ...
    return (
        <div className="article-form-wrap">
            <div className="article-form-card">
                ...
                <div className="article-form__header">
                    <div>
                        <h2 className="article-form__title">Редактиране на статия</h2>
                        <p className="article-form__sub">Обновете полетата и запазете промените.</p>
                    </div>
                ...
                <form className="article-form__body" onSubmit={handleSubmit} noValidate method="POST">
                    <div className="article-field">
                        <label htmlFor="ef-title" className="article-field__label">Заглавие</label>
                        <input
                            id="ef-title"
                            name="title"
                            type="text"
                    ...
                    <div className="article-field">
                        <label htmlFor="ef-text" className="article-field__label">Текст</label>
                        <textarea
                            id="ef-text"
                            name="text"
